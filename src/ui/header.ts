// This file contains the code for rendering the header section of the application.

import { getProfile } from "../api/profiles.ts";
import { clearSession, loadProfile } from "../utils/storages.ts";
...
export function renderHeader(): HTMLElement {
  ...
  avatar.src = `https://ui-avatars.com/api/?name=${encodeURIComponent(name)}&background=3f5b4a&color=ffffff`;
